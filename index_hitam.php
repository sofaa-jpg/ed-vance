...
<body class="bg-gray-900 text-white min-h-screen flex flex-col">
  <!-- Header -->
  <header class="bg-[#1e1b4b] flex justify-between items-center px-8 py-4 shadow-md">
  ...
  <main class="flex-grow flex flex-col md:flex-row items-center justify-center px-6 md:px-20 py-12 gap-12 md:gap-24">
    <img src="Gambar/Gambar1.png" alt="Gambar" class="w-80 md:w-[25rem]" />
    ...
    <section class="text-center md:text-left max-w-md">
      ...
      <div class="flex flex-col gap-6">
        <!-- Tombol Guru -->
        <button onclick="window.location.href='login_guru_hitam.php'" class="flex items-center justify-center gap-4 bg-gray-800 text-white rounded-lg py-4 px-8 shadow-lg hover:bg-gray-700 transition duration-300 font-robotoslab text-2xl select-none">
          <i class="fas fa-user text-4xl"></i>
          <?php echo "Guru"; ?>
        </button>

        <!-- Tombol Siswa -->
        <button onclick="window.location.href='login_siswa_hitam.php'" class="flex items-center justify-center gap-4 bg-gray-800 text-white rounded-lg py-4 px-8 shadow-lg hover:bg-gray-700 transition duration-300 font-robotoslab text-2xl select-none">
