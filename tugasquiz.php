...
<body class="bg-white">
  <div class="min-h-screen flex flex-col">
    ...
    <div class="flex flex-1">
      <nav id="sidebar" class="sidebar bg-[#9b95cc] flex flex-col items-start py-8 px-1 space-y-8 border border-black border-r-0">
        ...
        <!-- Menu lainnya -->
        <button class="menu-item-wrapper flex items-center space-x-2 text-black text-sm font-normal cursor-pointer select-none px-2 w-full" type="button">
          ...
          <table class="min-w-full border border-gray-300 bg-white shadow-md rounded">
            ...
            <tbody>
              <tr>
                ...
                <td class="border px-4 py-2">Bahasa Indonesia</td>
                <td class="border px-4 py-2 text-center">
                  <a href="quiz.php?mapel=bahasa_indonesia" class="bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-800">Lihat Quiz</a>
                </td>
              </tr>
              <tr>
                ...
                <td class="border px-4 py-2 text-center">
                  <a href="quiz.php?mapel=ipa" class="bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-800">Lihat Quiz</a>
                </td>
              </tr>
              <tr>
                <td class="border px-4 py-2 text-center">3</td>
                <td class="border px-4 py-2">IPS</td>
                <td class="border px-4 py-2 text-center">
                  <a href="quiz.php?mapel=ips" class="bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-800">Lihat Quiz</a>
                </td>
              </tr>
            </tbody>
          </table>
  ...
  <script>
    ...
    // Fungsi untuk aktifkan menu yang dipilih
