    ...
    <div class="flex flex-1">
      ...
      <nav id="sidebar" class="sidebar bg-[#9b95cc] flex flex-col py-8 px-1 space-y-2 border border-black border-r-0">
        <div class="menu-item-wrapper" data-menu="beranda">
          <a href="Dashboard_Guru.php" class="menu-item-wrapper flex items-center space-x-2 text-black text-sm font-normal cursor-pointer select-none px-0 w-full">
  ...
  <script>
    ...
    menuItems.forEach(item => {
      item.addEventListener('click', function () {
        // Expand sidebar jika belum
        if (!sidebar.classList.contains('expanded')) {
          sidebar.classList.add('expanded');
        }

        // Aktifkan hanya tombol yang diklik
