        ...
        <table class="w-full border-collapse border border-gray-400 text-xs">
          <thead>
            <tr class="bg-[#b0b4d1] text-center font-semibold">
              ...
              <th class="border border-gray-400 px-2 py-1 w-32">Opsi</th>
            </tr>
          </thead>
          <tbody>
            <tbody>
              ...
              ?>
                    <tr class="text-center hover:bg-gray-100">
                      ...
                      <td class="border border-gray-400 px-2 py-1">
                        <a href="detail_quiz.php?id=<?= $row['id'] ?>" class="bg-blue-600 hover:bg-blue-700 text-white px-2 py-1 rounded text-xs">Lihat Quiz</a>
                      </td>
                    </tr>
              <?php endwhile; ?>
            </tbody>
            <tr class="text-center">
              <td class="border border-gray-400 px-2 py-1" colspan="4"></td>
            </tr>
          </tbody>
        </table>
      </div>
