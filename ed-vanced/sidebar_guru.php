...
<body class="bg-white">
    <div class="flex flex-1">
      <nav id="sidebar" class="sidebar flex flex-col items-start py-6 px-2 space-y-6">
        ...
        <a href="tugas_quiz-guru.php" class="flex items-center space-x-2 text-black text-sm font-normal cursor-pointer select-none px-2 w-full">
          <span class="menu-icon"><i class="fas fa-lightbulb"></i></span>
          <span class="menu-item">Tugas/Quiz</span>
        </a>

        <a href="materi-guru.php" class="flex items-center space-x-2 text-black text-sm font-normal cursor-pointer select-none px-2 w-full">
