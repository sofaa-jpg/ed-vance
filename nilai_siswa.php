            ...
            <tbody>
              <tr>
                ...
                <td class="border px-4 py-2">
                  <a href="nilai.php?mapel=bahasa_indonesia" class="bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-800">Lihat Nilai</a>
                </td>
              </tr>
              <tr>
                ...
                <td class="border px-4 py-2">
                  <a href="nilai.php?mapel=ipa" class="bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-800">Lihat Nilai</a>
                </td>
              </tr>
              <tr>
                ...
                <td class="border px-4 py-2">
                  <a href="nilai.php?mapel=ips" class="bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-800">Lihat Nilai</a>
                </td>
              </tr>
            </tbody>
          </table>
