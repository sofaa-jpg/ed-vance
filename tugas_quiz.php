  ...
  <div class="min-h-screen flex flex-col">
    ...
    <div class="flex flex-1">
      ...
      <nav id="sidebar" class="sidebar bg-[#9b95cc] flex flex-col py-8 px-1 space-y-2 border border-black border-r-0">
        ...
        <div class="menu-item-wrapper active" data-menu="tugas">
      ...
      <main class="flex-1 bg-[#e6e6e6] p-6">
        <h2 class="text-2xl font-serif mb-2 border-b border-gray-300 pb-2">Tugas / Quiz</h2>
        <section class="bg-white p-6 shadow-sm">
          <div class="mb-4">
            <button class="bg-green-500 hover:bg-green-600 text-white text-xs px-3 py-1 rounded" type="button">
              Tambah Data
            </button>
          </div>
